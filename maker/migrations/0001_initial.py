# -*- coding: utf-8 -*-
# Generated by Django 1.11.2 on 2017-09-03 23:04
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Bs_t', models.FloatField(help_text='Constante de tensión de Byerlee (MPa)', verbose_name='Bₛ (t)')),
                ('Bs_c', models.FloatField(help_text='Constante de compresión de Byerlee (MPa)', verbose_name='Bₛ (c)')),
                ...
                ('s_max', models.FloatField(help_text='Máximo stress disponible (MPa)', verbose_name='σₘₐₓ')),
            ],
        ),
        migrations.CreateModel(
            name='Resolution',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Tp', models.FloatField(help_text='Temperatura potencial del manto astenosférico en la         superficie (ºC)', verbose_name='Tₚ')),
