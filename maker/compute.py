...
import sys
import django
sys.path.append("/home/idest/projects/andestm")
from django.conf import settings
os.environ.setdefault('DJANGO_SETTINGS_MODULE', 'andestm.development_settings')
django.setup()
from maker.models import RheologicModel
import pickle
import math
import numpy as np
...
t_data = load_obj('/home/idest/projects/andestm/misc/t_data')
m_data = load_obj('/home/idest/projects/andestm/misc/m_data')
areas = np.loadtxt('/home/idest/projects/andestm/misc/prints/oldareas2')

"""
import math
import numpy as np
from .models import GeometricData, RheologicModel, TrenchAge


GD = GeometricData.objects.get(pk=1)
TA = TrenchAge.objects.get(pk=1)
gm_data = np.loadtxt(GD.file.path)
ta_data = np.loadtxt(TA.file.path)
"""
